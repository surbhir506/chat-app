...
export default function ChatContainer() {
  ...
  return (
    ...
    <small style={{backgroundColor:'lightblue' , padding:5 , borderRadius:5}} >Interested in some 1 on 1 Coding Tutorials. Lets chat on Discord: <strong> kutlo_sekk#5370 </strong></small>
